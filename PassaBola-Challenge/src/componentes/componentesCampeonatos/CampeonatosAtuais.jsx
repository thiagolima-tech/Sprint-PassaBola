...
export default function CampeonatosAtuais() {
    return (
        <section>
            <Titulo
                title="Campeonatos Atuais"
                position="start"
                color="#300B74"
            />
            <div className="px-10 flex justify-center">
                <img src={anuncio} className="m-10 rounded-sm md:w-[70%] cursor-pointer" alt="Anuncio Copa Passa a Bola" />
            </div>
            <DocumentosCopa />
            <Titulo
                ...
                color="#300B74"
            />
            <div className="flex overflow-x-auto gap-6 px-10 pb-6
